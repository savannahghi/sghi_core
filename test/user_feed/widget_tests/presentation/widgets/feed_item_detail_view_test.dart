  ...
  group('Feed item detail view', () {
    ...
    testWidgets('should call state callbacks', (WidgetTester tester) async {
      await tester.runAsync(() async {
        ...
        final FeedItemContentViewState currentState =
        ...
        expect(
            () => currentState.onBodyLinkOrImageTapCallback(
                'http://example.com',
                renderContext,
                <String, String>{'test': 'attributes'},
                null),
            returnsNormally);

        expect(() => currentState.navigateWithPopCallback(), returnsNormally);
      });
    });
  });
}
